...
// console.log('compare', jackie.__proto__ === Person.prototype);
// console.log('__proto__', jackie.__proto__);

console.log(jackie.__proto__.constructor.name); // jackie instance inherit from Person
console.log(jackie.__proto__.__proto__.constructor.name); // Person inherit from Object
